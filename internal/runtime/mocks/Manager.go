...
// Add provides a mock function with given fields: runnable
func (_m *Manager) Add(runnable manager.Runnable) error {
...
func (_m *Manager) GetScheme() *pkgruntime.Scheme {
	ret := _m.Called()

	var r0 *pkgruntime.Scheme
	if rf, ok := ret.Get(0).(func() *pkgruntime.Scheme); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pkgruntime.Scheme)
		}
	}
